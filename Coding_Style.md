...
This is a coding style guide for languages I code in, any language specific ones are marked.

## 1. Indentation and layout
1.1 2 spaces for indentation, no tabs.
...
1.4 Line length should not exceed 110 characters.
...
2.4 Bind '*' or '&' to the variable, not the type
...
   int* a;
   int& b;
...
